    ...
    <div className='contact'>
      <div className='contact-container' id='contact'>
        <Fade left>
          ...
          <h1 className='contact-header'>What's Next?</h1>
          <h2 className='contact-get-in-touch'>Get In Touch</h2>
          <p className='contact-looking-for-work'>
            I am <b>currently looking for work</b> and am <b>open</b> to any new
            opportunities. Whether you may have a question, want to connect, or
            even just want to say hello, my inbox is always open and I will get
          ...
          <div>
            ...
            <div className='font-awesome-socials'>
              <a href='https://www.linkedin.com/in/armaankara'>
